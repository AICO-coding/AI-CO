...
class WrongAnswerListItem(BaseModel):
    ...
    track: str | None = Field(default=None, description="트랙명 (learning일 때만 존재)")
    chapter: str | None = Field(default=None, description="챕터명 (learning일 때만 존재)")
    title: str | None = Field(default=None, description="레슨 제목")
