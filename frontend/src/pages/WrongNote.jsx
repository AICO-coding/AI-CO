...
export default function WrongNotePage() {
  ...
  const dailyRate =
    dailyItems.length > 0
      ? Math.round(
          (dailyItems.filter((i) => i.isResolved).length / dailyItems.length) * 100
        )
      : 0;
      ...
      {loading ? (
        ...
        <div className="wn-track-grid">
            ...
            return (
              ...
              >
                ...
                <div className="wn-track-progress-bar">
                  <div className="wn-track-progress-fill" style={{ width: `${resolvedRate}%` }} />
                </div>
          ...
          >
            ...
            <div className="wn-track-progress-bar">
              <div className="wn-track-progress-fill wn-daily-fill" style={{ width: `${dailyRate}%` }} />
            </div>
            <div className="wn-track-stats">
