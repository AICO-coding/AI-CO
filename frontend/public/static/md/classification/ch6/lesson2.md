<div style="background-color: #eef7ff; border: 2px solid #c2e4ff; border-radius: 12px; padding: 20px; font-family: sans-serif;">
  ...
  <div style="line-height: 2.2; color: #334155; font-size: 14px;">
    ...
    앞 글자는 맞았는지
    <span style="background: #fff; border: 1px solid #c2e4ff; color: #1681c4; padding: 2px 6px; border-radius: 4px; font-family: monospace;">True / False</span>,
    뒷 글자는 어떻게 예측했는지
    <span style="background: #fff; border: 1px solid #ffd0b0; color: #FF6B00; padding: 2px 6px; border-radius: 4px; font-family: monospace;">Positive / Negative</span>
    를 나타냅니다.<br><br>
    FP와 FN 중 어느 쪽이 더 치명적인지는 문제마다 다릅니다. 암 진단에서는 <b>FN(환자를 정상으로 판단)</b>이 더 위험합니다. 스팸 필터에서는 <b>FP(정상 메일을 스팸으로 판단)</b>가 더 불편합니다.
  </div>
  ...
  <div style="margin-top: 12px; background: #f1f5f9; border-radius: 8px; padding: 12px 14px; font-size: 13px; color: #334155;">
    <b>📋 Confusion Matrix 구조</b><br><br>
    <table style="width:100%; border-collapse:collapse; font-size:12px; text-align:center;">
      <tr>
        <td style="padding:6px; color:#94a3b8;"></td>
        <td style="padding:6px; font-weight:900; color:#1681c4;">예측: 양성</td>
        <td style="padding:6px; font-weight:900; color:#1681c4;">예측: 음성</td>
      </tr>
      <tr>
        <td style="padding:6px; font-weight:900; color:#FF6B00;">실제: 양성</td>
        <td style="padding:8px; background:#dcfce7; border-radius:6px; font-weight:900; color:#166534;">TP</td>
        <td style="padding:8px; background:#fee2e2; border-radius:6px; font-weight:900; color:#991b1b;">FN</td>
      </tr>
      <tr>
        <td style="padding:6px; font-weight:900; color:#FF6B00;">실제: 음성</td>
        <td style="padding:8px; background:#fef9c3; border-radius:6px; font-weight:900; color:#713f12;">FP</td>
        <td style="padding:8px; background:#dcfce7; border-radius:6px; font-weight:900; color:#166534;">TN</td>
      </tr>
    </table>
  </div>
</div>
