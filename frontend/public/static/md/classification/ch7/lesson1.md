<div style="background-color: #eef7ff; border: 2px solid #c2e4ff; border-radius: 12px; padding: 20px; font-family: sans-serif;">
  ...
  <div style="line-height: 2.2; color: #334155; font-size: 14px;">
    <span style="background: #fff; border: 1px solid #c2e4ff; color: #1681c4; padding: 2px 8px; border-radius: 4px; font-weight: 700;">Bias</span>
    는 모델의 예측이 실제 정답으로부터 얼마나 벗어나 있는지를 나타냅니다. Bias가 높으면 훈련 데이터조차 제대로 맞추지 못합니다. 이를
    <span style="background: #fff; border: 1px solid #ffd0b0; color: #FF6B00; padding: 2px 8px; border-radius: 4px; font-weight: 700;">과소적합 (underfitting)</span>
    이라고 합니다.<br><br>
  ...
  <div style="margin-top: 16px; display: flex; flex-direction: column; gap: 8px; font-size: 13px;">
    ...
    <div style="background: #eef7ff; border-radius: 8px; padding: 10px 14px; color: #334155;">
      📌 <b>진단 방법</b> — train 정확도가 낮은가? → YES → High Bias (underfitting)
    </div>
  </div>
</div>
