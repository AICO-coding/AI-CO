<div style="background-color: #eef7ff; border: 2px solid #c2e4ff; border-radius: 18px; padding: 24px 26px; font-family: 'Nunito', 'Pretendard', 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif; box-shadow: 0 6px 18px rgba(15, 23, 42, 0.06);">
  ...
  <div style="line-height: 2.2; color: #334155; font-size: 14px;">
    ...
    <span style="background: #fff; border: 1px solid #ffd0b0; color: #FF6B00; padding: 2px 6px; border-radius: 6px; font-weight: 700;">High Bias</span>
    (underfitting)입니다. train은 높은데 test가 낮으면
    <span style="background: #fff; border: 1px solid #ffd0b0; color: #FF6B00; padding: 2px 6px; border-radius: 6px; font-weight: 700;">High Variance</span>
  ...
  <div style="margin-top: 16px; display: flex; flex-direction: column; gap: 8px; font-size: 13px;">
    <div style="background: #fee2e2; border-radius: 12px; padding: 12px 15px; color: #991b1b;">
      ❌ train 낮음 + test 낮음 → <b>High Bias (underfitting)</b>
    </div>
    <div style="background: #fef9c3; border-radius: 12px; padding: 12px 15px; color: #713f12;">
      ⚠️ train 높음 + test 낮음 → <b>High Variance (overfitting)</b>
    </div>
    ...
    <div style="background: #fff3eb; border: 1px solid #ffd0b0; border-radius: 12px; padding: 12px 15px; color: #334155;">
      💡 <b>트레이드오프 핵심</b> — 둘 다 동시에 낮추기는 어렵습니다. 데이터를 늘리는 것이 가장 근본적인 해결책입니다
    </div>
  </div>
</div>
