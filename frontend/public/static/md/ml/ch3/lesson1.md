<div style="background-color: #eef7ff; border: 2px solid #c2e4ff; border-radius: 12px; padding: 20px; font-family: sans-serif;">
  ...
  <div style="line-height: 2.2; color: #334155; font-size: 14px;">
    ...
    <span style="background: #fff; border: 1px solid #e2e8f0; color: #334155; padding: 2px 8px; border-radius: 4px; font-family: monospace;">(w·X + b)</span>
    을 반복합니다. 그런데 선형 변환을 아무리 많이 쌓아도 결과는 여전히 선형입니다. 층을 10개 쌓든 100개 쌓든 수식으로 정리하면 결국
    <span style="background: #fff; border: 1px solid #ffd0b0; color: #FF6B00; padding: 2px 8px; border-radius: 4px; font-family: monospace;">w·X + b</span>
    하나와 같습니다.<br><br>
    즉 층을 깊게 쌓는 의미가 사라집니다. 직선 하나로 표현할 수 없는 복잡한 패턴은 아무리 층을 늘려도 학습할 수 없습니다.<br><br>
    <span style="background: #fff; border: 1px solid #c2e4ff; color: #1681c4; padding: 2px 8px; border-radius: 4px; font-weight: 700;">활성화 함수</span>
